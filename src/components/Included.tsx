...
const items = [
  {
    ...
    title: 'White-background hero image',
    desc: 'Clean, marketplace-ready main product image on pure white.',
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'Lifestyle / in-use product images',
    desc: 'Show your product in real-world settings that help buyers understand and trust it.',
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'Infographic / benefit images',
    desc: 'Highlight key features, benefits, ingredients, specs, or use cases in a clear visual format.',
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'Up to 10 total product images',
    desc: 'We build the image mix around what your product actually needs.',
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    desc: 'We refine the images based on your feedback.',
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    desc: 'Most packages are delivered within 72 hours after we receive everything needed.',
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'Files ready for every store',
    desc: 'Delivered in the right sizes and formats for Amazon, Shopify, eBay, websites, and ads.',
  },
]
          ...
          <div className="space-y-8">
            <div className="space-y-3">
              ...
              <h2 className="text-3xl lg:text-4xl font-extrabold text-[#111827] leading-tight">
                Complete Product<br />Image Package
              </h2>
              <p className="text-gray-600 leading-relaxed">
                Everything you need to make your product stand out across Amazon, Shopify, eBay, websites, and ads — delivered fast.
              </p>
            </div>
            ...
            <ul className="space-y-4">
              {items.map((item) => (
                <li key={item.title} className="flex items-start gap-3.5">
                  <div className="flex-shrink-0 mt-0.5 w-9 h-9 rounded-xl bg-[#1476ff]/10 text-[#1476ff] flex items-center justify-center">
                    {item.icon}
                  </div>
                  <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="rounded-2xl overflow-hidden shadow-md border border-gray-100 relative">
              <Image
                ...
                unoptimized
              />
              <span className="absolute top-2 left-2 bg-[#1476ff] text-white text-[10px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wide shadow">
                Infographic
              </span>
            </div>
          </div>
